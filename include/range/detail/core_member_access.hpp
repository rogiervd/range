...
namespace range { namespace helper {
    ...
    || (__GNUC__ == 4 && __GNUC_MINOR__ > 6)
        ...
        // default_direction.
        template <class Range> static auto default_direction(Range && range)
        ...
        static auto at_constant(
            Range && range, Position const & position,
            Direction const & direction)
            RETURNS(
                std::forward<Range>(range).at_constant(position, direction));

        template <class Range, class Position, class Direction> static auto at(
            Range && range, Position const & position,
            Direction const & direction)
        ...
        static auto drop_constant(
            Range && range, Increment const & increment,
            Direction const & direction)
            RETURNS(
                std::forward<Range>(range).drop_constant(increment, direction));
        ...
        // chop_in_place.
        template <class Range, class Direction>
        static auto chop_in_place(Range && range, Direction const & direction)
