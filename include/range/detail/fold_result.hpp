...
namespace range { namespace fold_detail {
    ...
    */
    ...
    public:
        ...
        template <class State, class Range> struct result<step<State, Range>>
        {
            ...
            */
            ...
            typedef typename result_of<range::callable::chop(
                Range, Direction)>::type chopped_type;
            typedef typename chopped_type::first_type first_type;
            typedef typename chopped_type::rest_type next_range_type;

            typedef typename result_of<Function(State &&, first_type)>::type
                next_state_type;
    ...
    */
    template <
        class Direction, class Function, class Step,
    ...
    {
        typedef
            typename next_step<Direction, Function>::template result<Step>::type
                next_step;
        typedef typename all_steps<
            Direction, Function, next_step,
            typename meta::push<meta::front, Step, PreviousSteps>::type>::type
            type;
    };
    ...
    */
    ...
    {
        typedef
            typename all_steps<Direction, Function, step<State, Range>>::type
                steps;

        typedef typename meta::as_vector<meta::filter<
            step_may_be_empty<boost::mpl::_1, Direction>, steps>>::type
            returnable_steps;
        ...
        typedef typename meta::fold<
            meta::insert<boost::mpl::_2, boost::mpl::_1>, meta::set<>,
            meta::transform<get_state<boost::mpl::_1>, returnable_steps>>::type
            type;
    };
