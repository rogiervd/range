...
namespace range { namespace tuple_detail {
    ...
    */
    ...
    struct types<tuple_view<Begin, End, TupleReference>>
    {
        ...
        {
            typedef meta::vector<
                decltype(extract<((tuple_size - Begin - 1) - Indices)>()(
                    std::declval<TupleReference>()))...>
                type;
        };

        typedef
            typename compute<typename meta::count_c<End - Begin>::type>::type
                type;
    };
    ...
    template <
        std::size_t LeftSize, std::size_t RightSize, class LeftView,
        class RightView, class Predicate>
    inline rime::false_type equal(
        tuple_view_tag<LeftSize>, tuple_view_tag<RightSize>, LeftView const &,
        RightView const &, direction::front, Predicate &&)
    {
        return rime::false_;
    }
    ...
    namespace equal_detail {
            ...
            typename rime::enable_if_constant<Result>::type>
        {
            ...
            Result operator()(Left const &, Right const &, Predicate &&) const
            {
                return Result();
            }
        };
        ...
        {
            template <class Left, class Right, class Predicate>
            bool operator()(Left const &, Right const &, Predicate &&) const
            {
                return true;
            }
        };
        ...
        {
        private:
            template <class Left, class Right, class Predicate> bool implement(
                Left const & left, Right const & right, Predicate && predicate,
                bool first_result, utility::overload_order<2> *) const
            {
                return first_result
                    && equal_implementation<
            ...
            // comparison.
            template <class Left, class Right, class Predicate> bool implement(
                Left const &, Right const &, Predicate &&, rime::false_type,
        ...
        public:
            template <class Left, class Right, class Predicate> bool operator()(
        ...
        template <class... PredicateResults> struct equal_implementation<
            bool, meta::vector<bool, bool, PredicateResults...>>
        {
            template <class Left, class Right, class Predicate> bool operator()(
                Left const & left, Right const & right,
                Predicate && predicate) const
        ...
        template <class... PredicateResults> struct equal_implementation<
            bool, meta::vector<bool, bool, bool, PredicateResults...>>
        {
            template <class Left, class Right, class Predicate> bool operator()(
                Left const & left, Right const & right,
                Predicate && predicate) const
        ...
        // equal.
        template <
            class LeftTypes, class RightTypes, class Predicate,
            class Enable = void>
        struct equal;

        template <class... LeftTypes, class... RightTypes, class Predicate>
        struct equal<
            meta::vector<LeftTypes...>, meta::vector<RightTypes...>, Predicate,
    ...
    template <
        std::size_t Size, class LeftView, class RightView, class Predicate>
    ...
    namespace less_lexicographical_detail {
        ...
        */
        ...
        {
            typedef meta::vector<
                typename compute_predicate_result<
                    LeftTypes, RightTypes, Predicate>::type...,
                // Make the result for empty sequences correct.
                boost::mpl::pair<rime::false_type, rime::true_type>>
                type;
        };
        ...
        */
        ...
        struct pad_with_void<meta::vector<Types...>, meta::vector<PadTypes...>>
        {
            typedef meta::vector<
                Types..., typename make_void<PadTypes>::type...>
                type;
        };
        ...
        : std::conditional<
              ...
              predicate_results_left_shorter<
        ...
        // result.
        template <
            class PredicateResults, class Enable1 = void, class Enable2 = void>
        struct result;
        ...
        private:
            ...
            template <class Left, class Right, class Predicate>
            bool implement_2(
                Left const &, Right const &, Predicate &&, rime::true_type,
                bool, utility::overload_order<1> *) const
            {
                return true;
            }
            ...
            template <class Left, class Right, class Predicate>
            bool implement_2(
                Left const &, Right const &, Predicate &&, bool,
                rime::true_type, utility::overload_order<1> *) const
            {
                return false;
            }
            ...
            template <class Left, class Right, class Predicate> bool implement(
                Left const & left, Right const & right, Predicate && predicate,
                rime::false_type, rime::false_type) const
            {
                return implement_2(
                    left, right, predicate,
                    predicate(range::first(left), range::first(right)),
        ...
        public:
            ...
            {
                return implement(
                    left, right, predicate, range::empty(left),
                    range::empty(right));
            }
        };
        ...
        struct less_lexicographical_implementation<
            bool,
            meta::vector<boost::mpl::pair<bool, bool>, PredicateResults...>>
        {
            template <class Left, class Right, class Predicate> bool operator()(
                Left const & left, Right const & right,
                Predicate && predicate) const
        ...
        struct less_lexicographical_implementation<
            bool,
            meta::vector<
                boost::mpl::pair<bool, bool>, boost::mpl::pair<bool, bool>,
                PredicateResults...>>
        {
            template <class Left, class Right, class Predicate> bool operator()(
                Left const & left, Right const & right,
