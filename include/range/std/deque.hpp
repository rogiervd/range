...
/** \file
Turn \c std::deque into a range.
This includes \c \<deque>.
*/

#ifndef RANGE_STD_DEQUE_HPP_INCLUDED
#define RANGE_STD_DEQUE_HPP_INCLUDED
...
#endif  // RANGE_STD_DEQUE_HPP_INCLUDED
