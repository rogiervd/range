...
/** \file
Turn \c std::forward_list into a range.
This includes \c \<forward_list>.
*/

#ifndef RANGE_FORWARD_LIST_HPP_INCLUDED
#define RANGE_FORWARD_LIST_HPP_INCLUDED
...
#endif  // RANGE_FORWARD_LIST_HPP_INCLUDED
