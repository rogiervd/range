...
/** \file
Turn \c std::unordered_map into a range.
This includes \c \<unordered_map>.
*/

#ifndef RANGE_STD_UNORDERED_MAP_HPP_INCLUDED
#define RANGE_STD_UNORDERED_MAP_HPP_INCLUDED
