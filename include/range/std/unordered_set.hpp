...
/** \file
Turn \c std::unordered_set into a range.
This includes \c \<unordered_set>.
*/

#ifndef RANGE_STD_UNORDERED_SET_HPP_INCLUDED
#define RANGE_STD_UNORDERED_SET_HPP_INCLUDED
