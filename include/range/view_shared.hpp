...
public:
    ...
    : heavyweight_(std::move(heavyweight)), underlying_(std::move(underlying))
    {}
...
private:
    ...
    template <class Direction> typename result_of<
        range::callable::empty(underlying_type const &, Direction)>::type
    ...
    template <class Direction> typename result_of<
        range::callable::size(underlying_type const &, Direction)>::type
    ...
    template <class Direction> typename result_of<
        range::callable::chop_in_place(underlying_type &, Direction)>::type
...
namespace view_shared_detail {
    ...
    {
        template <class Heavyweight, class View>
        view_of_shared<Heavyweight, typename std::decay<View>::type> operator()(
            std::shared_ptr<Heavyweight> heavyweight, View && view) const
        {
...
namespace callable {
    ...
    public:
        ...
        template <
            ...
            class View =
                typename make_view_if_range<MakeView, Heavyweight>::type>
        view_of_shared<Heavyweight, View> operator()(
            std::shared_ptr<Heavyweight> heavyweight,
        ...
        template <
            ...
            class View =
                typename make_view_if_range<MakeView, Heavyweight>::type>
        view_of_shared<typename std::decay<Heavyweight>::type, View> operator()(
            Heavyweight && heavyweight, MakeView const & make_view) const
        {
        ...
        template <
            ...
            class Enable =
                typename boost::enable_if<is_range<Heavyweight>>::type>
        view_of_shared<Heavyweight> operator()(
            std::shared_ptr<Heavyweight> heavyweight) const
        {
        ...
        template <
            ...
            class Enable =
                typename boost::enable_if<is_range<Heavyweight>>::type>
        view_of_shared<typename std::decay<Heavyweight>::type> operator()(
            Heavyweight && heavyweight) const
        {
            return operator()(
                std::make_shared<typename std::decay<Heavyweight>::type>(
                    std::forward<Heavyweight>(heavyweight)));
