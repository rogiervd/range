...
std::tuple<double, std::string> get_double_string() { return double_string; }
...
auto get_twice(int i, float f) RETURNS(
    range::transform(range::view_shared(get_int_float_string(i, f)), twice()));
