    ...
    */
    ...
    static_assert(
        std::is_same<
            ...
            any_range<
                int &,
                map<map_element<default_direction, direction::front>,
                    map_element<copy_construct, void>,
                    map_element<
                        direction::front,
                        set<empty, size, first, drop_one, drop_n,
                            chop_destructive>>,
                    map_element<
                        direction::back,
                        set<empty, size, first, drop_one, drop_n,
        ...
        std::is_same<
            ...
            any_range<
                ...
                map<map_element<default_direction, direction::front>,
                    ...
                    map_element<
                        direction::front,
                        set<empty, first, drop_one, chop_destructive>>,
                    map_element<
                        direction::back,
                        set<empty, first, drop_one, chop_destructive>>>>>::
            value,
    ...
    static_assert(
        std::is_same<
            ...
            any_range<
                ...
                map<map_element<default_direction, direction::front>,
                    map_element<
                        direction::front, set<empty, chop_destructive>>>>>::
            value,
        "");
        ...
        std::is_same<
            ...
            any_range<
                ...
                map<map_element<default_direction, direction::front>,
                    ...
                    map_element<
                        direction::front,
                        set<empty, size, first, drop_one, chop_destructive>>,
                    map_element<
                        direction::back,
                        set<empty, size, first, drop_one,
                            chop_destructive>>>>>::value,
        "");
}
