...
BOOST_AUTO_TEST_CASE(test_range_hash_heterogeneous)
{
...

    {
...

        {
            ...
            BOOST_CHECK_EQUAL(hash_range(t, range::front), reference_seed);
...
BOOST_AUTO_TEST_CASE(test_range_hash_properties)
{
    ...
    BOOST_CHECK(
        hash_range(four_half_seven) != hash_range(four_half_seven_twenty));
...
{
    std::unordered_set<
        range::tuple<int, std::string>, range::callable::hash_range>
        s;
